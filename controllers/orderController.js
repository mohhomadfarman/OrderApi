...
exports.createDryCleaningOrder = async (req, res) => {
    const { customerName, mobileNumber, articles, pickupDate, deliveryDate } = req.body;
    ...
    try {
      ...
      io.emit('newDryCleaningOrder', { customerName, totalPrice, pickupDate: pickupDateTime, deliveryDate: deliveryDateTime });
    } catch (error) {
